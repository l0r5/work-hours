...
const headCells = [
    ...
    {id: 'workHours', numeric: true, disablePadding: true, label: 'Work Hours'},
    {id: 'chainsawHours', numeric: true, disablePadding: true, label: 'Chainsaw Hours'},
    {id: 'machineHours', numeric: true, disablePadding: true, label: 'Machine Hours'},
                                ...
                                .map((row, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{row.chainsawHours}</TableCell>
                                            <TableCell align="right">{row.machineHours}</TableCell>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
